...
\input{DesignDoc_Intro}

\input{DesignDoc_definitions}

\input{DesignDoc_Chap3}

\section{Database}

\input{DesignDoc_Database}

\section{Neural Net}

\input{DesignDoc_Neural}

\section{Camera}

\input{DesignDoc_Camera}

\section{Vision Processing}

\input{DesignDoc_Vision}
